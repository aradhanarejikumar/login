...
<div class="row py-5 mx-5">
      <div class="col-sm-3">
      <div class="card bg-danger text-center" style="width: 18rem;">
      <div class="card-body">
      <h3 class="card-title">STUDENTS</h3>
      <h4 class="card-subtitle mb-2 text-light"></h4>
      <p class="card-text"></p>
    </div>
    </div>
    </div>
...
<div class="row py-5 mx-5">
  ...
  <div class="col-sm-3">
    <div class="card bg-p text-center" style="width: 18rem;">
    <div class="card-body">
...
<div class="row py-5 mx-5">
  ...
  <div class="col-sm-3">
    <div class="card bg-danger text-center" style="width: 18rem;">
    <div class="card-body">
    <h3 class="card-title">INTERNALS</h3>
    <h4 class="card-subtitle mb-2 text-light"></h4>
    <p class="card-text"></p>
  </div>
  </div>
